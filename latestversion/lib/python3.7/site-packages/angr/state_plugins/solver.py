...
class SimSolver(SimStatePlugin):
    ...
    def copy(self, memo): # pylint: disable=unused-argument
        test = type(self)(solver=self._solver.branch())
        test.all_variables = self.all_variables
        test.temporal_tracked_variables = self.temporal_tracked_variables
        test.eternal_tracked_variables = self.eternal_tracked_variables
        return test;
