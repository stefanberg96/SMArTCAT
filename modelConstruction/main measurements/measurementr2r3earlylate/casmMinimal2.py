...
allInstructions = ["ADC<c> <Rd>, <Rn>, #<const>", "ADC<c> <Rd>, <Rn>, <Rm>, <shift>", "ADC<c> <Rd>, <Rn>, <Rm>", "ADC<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "ADD<c> <Rd>, <Rn>, #<const>", "ADD<c> <Rd>, <Rn>, <Rm>, <shift>", "ADD<c> <Rd>, <Rn>, <Rm>", "ADD<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "ADD<c> <Rd>, SP, #<const>", "ADD<c> <Rd>, SP, <Rm>, <shift>", "ADD<c> <Rd>, SP, <Rm>", "ADR<c> <Rd>, <label>", "AND<c> <Rd>, <Rn>, #<const>", "AND<c> <Rd>, <Rn>, <Rm>, <shift>", "AND<c> <Rd>, <Rn>, <Rm>", "AND<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "ASR<c> <Rd>, <Rm>, #<imm>", "ASR<c> <Rd>, <Rn>, <Rm>", "B<c> <label>", "BIC<c> <Rd>, <Rn>, #<const>", "BIC<c> <Rd>, <Rn>, <Rm>, <shift>", "BIC<c> <Rd>, <Rn>, <Rm>", "BIC<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "BKPT #<imm16>", "BL<c> <label>", "BLX<c> <Rm>", "BX<c> <Rm>", "CLZ<c> <Rd>, <Rm>", "CMN<c> <Rn>, #<const>", "CMN<c> <Rn>, <Rm>, <shift>", "CMN<c> <Rn>, <Rm>", "CMN<c> <Rn>, <Rm>, <type> <Rs>", "CMP<c> <Rn>, #<const>", "CMP<c> <Rn>, <Rm>, <shift>", "CMP<c> <Rn>, <Rm>", "CMP<c> <Rn>, <Rm>, <type> <Rs>", "DBG<c> #<option>", "DMB <option>", "DSB <option>", "EOR<c> <Rd>, <Rn>, #<const>", "EOR<c> <Rd>, <Rn>, <Rm>, <shift>", "EOR<c> <Rd>, <Rn>, <Rm>", "EOR<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "ISB <option>", "LSL<c> <Rd>, <Rm>, #<imm5>", "LSL<c> <Rd>, <Rn>, <Rm>", "LSR<c> <Rd>, <Rm>, #<imm>", "LSR<c> <Rd>, <Rn>, <Rm>", "MLA<c> <Rd>, <Rn>, <Rm>, <Ra>", "MOV<c> <Rd>, #<const>", "MOV<c> <Rd>, <Rm>", "MRS<c> <Rd>, <spec_reg>", "MSR<c> <spec_reg>, #<const>", "MSR<c> <spec_reg>, <Rn>", "MUL<c> <Rd>, <Rn>, <Rm>", "MVN<c> <Rd>, #<const>", "MVN<c> <Rd>, <Rm>, <shift>", "MVN<c> <Rd>, <Rm>", "MVN<c> <Rd>, <Rm>, <type> <Rs>", "NOP<c>", "ORR<c> <Rd>, <Rn>, #<const>", "ORR<c> <Rd>, <Rn>, <Rm>, <shift>", "ORR<c> <Rd>, <Rn>, <Rm>", "ORR<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "QADD<c> <Rd>, <Rm>, <Rn>", "QADD16<c> <Rd>, <Rn>, <Rm>", "QADD8<c> <Rd>, <Rn>, <Rm>", "QASX<c> <Rd>, <Rn>, <Rm>", "QDADD<c> <Rd>, <Rm>, <Rn>", "QDSUB<c> <Rd>, <Rm>, <Rn>", "QSAX<c> <Rd>, <Rn>, <Rm>", "QSUB<c> <Rd>, <Rm>, <Rn>", "QSUB16<c> <Rd>, <Rn>, <Rm>", "QSUB8<c> <Rd>, <Rn>, <Rm>", "RBIT<c> <Rd>, <Rm>", "REV<c> <Rd>, <Rm>", "REV16<c> <Rd>, <Rm>", "REVSH<c> <Rd>, <Rm>", "ROR<c> <Rd>, <Rm>, #<imm>", "ROR<c> <Rd>, <Rn>, <Rm>", "RRX <Rd>, <Rm>", "RSB<c> <Rd>, <Rn>, #<const>", "RSB<c> <Rd>, <Rn>, <Rm>, <shift>", "RSB<c> <Rd>, <Rn>, <Rm>", "RSB<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "RSC<c> <Rd>, <Rn>, #<const>", "RSC<c> <Rd>, <Rn>, <Rm>, <shift>", "RSC<c> <Rd>, <Rn>, <Rm>", "RSC<c> <Rd>, <Rn>, <Rm>, <type> <Rs>",  "SADD16<c> <Rd>, <Rn>, <Rm>", "SADD8<c> <Rd>, <Rn>, <Rm>", "SASX<c> <Rd>, <Rn>, <Rm>", "SBC<c> <Rd>, <Rn>, #<const>", "SBC<c> <Rd>, <Rn>, <Rm>, <shift>", "SBC<c> <Rd>, <Rn>, <Rm>", "SBC<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "SEL<c> <Rd>, <Rn>, <Rm>", "SHADD16<c> <Rd>, <Rn>, <Rm>", "SHADD8<c> <Rd>, <Rn>, <Rm>", "SHASX<c> <Rd>, <Rn>, <Rm>", "SHSAX<c> <Rd>, <Rn>, <Rm>", "SHSUB16<c> <Rd>, <Rn>, <Rm>", "SHSUB8<c> <Rd>, <Rn>, <Rm>", "SMLA<x><y><c> <Rd>, <Rn>, <Rm>, <Ra>", "SMLAD{X}<c> <Rd>, <Rn>, <Rm>, <Ra>", "SMLAL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "SMLALD{X}<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "SMLAW<y><c> <Rd>, <Rn>, <Rm>, <Ra>", "SMLSD{X}<c> <Rd>, <Rn>, <Rm>, <Ra>", "SMLSLD{X}<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "SMMLA{R}<c> <Rd>, <Rn>, <Rm>, <Ra>", "SMMLS{R}<c> <Rd>, <Rn>, <Rm>, <Ra>", "SMMUL{R}<c> <Rd>, <Rn>, <Rm>", "SMUAD{X}<c> <Rd>, <Rn>, <Rm>", "SMUL<x><y><c> <Rd>, <Rn>, <Rm>", "SMULL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "SMULW<y><c> <Rd>, <Rn>, <Rm>", "SMUSD{X}<c> <Rd>, <Rn>, <Rm>", "SSAT<c> <Rd>, #<imm>, <Rn>, <shift>", "SSAT<c> <Rd>, #<imm>, <Rn>", "SSAT16<c> <Rd>, #<imm>, <Rn>", "SSAX<c> <Rd>, <Rn>, <Rm>", "SSUB16<c> <Rd>, <Rn>, <Rm>", "SSUB8<c> <Rd>, <Rn>, <Rm>", "SUB<c> <Rd>, <Rn>, #<const>", "SUB<c> <Rd>, <Rn>, <Rm>, <shift>", "SUB<c> <Rd>, <Rn>, <Rm>", "SUB<c> <Rd>, <Rn>, <Rm>, <type> <Rs>", "SUB<c> <Rd>, SP, #<const>", "SUB<c> <Rd>, SP, <Rm>, <shift>", "SUB<c> <Rd>, SP, <Rm>", "SXTAB<c> <Rd>, <Rn>, <Rm>, <rotation>", "SXTAB<c> <Rd>, <Rn>, <Rm>", "SXTAB16<c> <Rd>, <Rn>, <Rm>, <rotation>", "SXTAB16<c> <Rd>, <Rn>, <Rm>", "SXTAH<c> <Rd>, <Rn>, <Rm>, <rotation>", "SXTAH<c> <Rd>, <Rn>, <Rm>", "SXTB<c> <Rd>, <Rm>, <rotation>", "SXTB<c> <Rd>, <Rm>", "SXTB16<c> <Rd>, <Rm>, <rotation>", "SXTB16<c> <Rd>, <Rm>", "SXTH<c> <Rd>, <Rm>, <rotation>", "SXTH<c> <Rd>, <Rm>", "TEQ<c> <Rn>, <Rm>, <shift>", "TEQ<c> <Rn>, <Rm>", "TEQ<c> <Rn>, <Rm>, <type> <Rs>", "TST<c> <Rn>, #<const>", "TST<c> <Rn>, <Rm>, <shift>", "TST<c> <Rn>, <Rm>", "TST<c> <Rn>, <Rm>, <type> <Rs>", "UADD16<c> <Rd>, <Rn>, <Rm>", "UADD8<c> <Rd>, <Rn>, <Rm>", "UASX<c> <Rd>, <Rn>, <Rm>", "UBFX<c> <Rd>, <Rn>, #<lsb>, #<width>", "UHADD16<c> <Rd>, <Rn>, <Rm>", "UHADD8<c> <Rd>, <Rn>, <Rm>", "UHASX<c> <Rd>, <Rn>, <Rm>", "UHSAX<c> <Rd>, <Rn>, <Rm>", "UHSUB16<c> <Rd>, <Rn>, <Rm>", "UHSUB8<c> <Rd>, <Rn>, <Rm>", "UMAAL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "UMLAL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "UMULL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "UQADD16<c> <Rd>, <Rn>, <Rm>", "UQADD8<c> <Rd>, <Rn>, <Rm>", "UQASX<c> <Rd>, <Rn>, <Rm>", "UQSAX<c> <Rd>, <Rn>, <Rm>", "UQSUB16<c> <Rd>, <Rn>, <Rm>", "UQSUB8<c> <Rd>, <Rn>, <Rm>", "USAD8<c> <Rd>, <Rn>, <Rm>", "USADA8<c> <Rd>, <Rn>, <Rm>, <Ra>", "USAT<c> <Rd>, #<imm5>, <Rn>, <shift>", "USAT<c> <Rd>, #<imm5>, <Rn>", "USAT16<c> <Rd>, #<imm4>, <Rn>", "USAX<c> <Rd>, <Rn>, <Rm>", "USUB16<c> <Rd>, <Rn>, <Rm>", "USUB8<c> <Rd>, <Rn>, <Rm>", "UXTAB<c> <Rd>, <Rn>, <Rm>, <rotation>", "UXTAB<c> <Rd>, <Rn>, <Rm>", "UXTAB16<c> <Rd>, <Rn>, <Rm>, <rotation>", "UXTAB16<c> <Rd>, <Rn>, <Rm>", "UXTAH<c> <Rd>, <Rn>, <Rm>, <rotation>", "UXTAH<c> <Rd>, <Rn>, <Rm>", "UXTB<c> <Rd>, <Rm>, <rotation>", "UXTB<c> <Rd>, <Rm>", "UXTB16<c> <Rd>, <Rm>, <rotation>", "UXTB16<c> <Rd>, <Rm>", "UXTH<c> <Rd>, <Rm>, <rotation>", "UXTH<c> <Rd>, <Rm>", "UMLAL<c> <RdLo>, <RdHi>, <Rn>, <Rm>", "UMULL<c> <RdLo>, <RdHi>, <Rn>, <Rm>"]
