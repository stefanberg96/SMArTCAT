...
issueTiming = "BLXvs r0; "   #MLA instruction seems unable to execute in parallel with previous instructions (wrong)
latencyTiming = "mla r1, lr, r1, r0; "
    ...
    for format in casm.allInstructions:
        for insn in casm.Formatted(format):
            ...
            for asmString in testString(insn[0], insn[1]):
                ...
                issAsmString = "%s %s; %s;" % (issueTiming, asmString, insn[0])
