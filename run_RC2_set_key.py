...
import settings
import claripy
settings.WARNING_ADDRESS = 0x50E8fc
settings.WARNING_MOMENT = settings.WARNING_AFTER
settings.VERBOSE = True
settings.TARGET_ADDRESS = 0x50E7FC
settings.TARGET_FUNCTION = "RC2_set_key"
...
settings.params = [settings.outputBuf, settings.len, settings.keyBuf, settings.len*8]
